 ...
 * @author ngocanh
 */
public class ChiTietMuaHangpanel extends javax.swing.JPanel {
    ...
    public void ShowData() throws SQLException{
        List<ChiTietMuaHang> list = ct.getall(maPX);
        tableModel.setRowCount(0);
        for(ChiTietMuaHang ctpx:list){
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Chi tiết mua hàng");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Tên SP");

        btnXoaCTPX.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnXoaCTPX.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Close.png"))); // NOI18N
        ...
        tblCTPX.setBackground(new java.awt.Color(255, 251, 241));
        ...
        btnThemCTPX.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Plus_1.png"))); // NOI18N
    ...
    private void tblCTPXMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTPXMouseClicked
        try {
            ...
            ChiTietMuaHang obj=ct.getCTMH(maPX,mabt);
            if(obj!=null){
