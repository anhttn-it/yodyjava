 ...
 * @author ngocanh
 */
public class frmPhieuXuat extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(frmPhieuXuat.class.getName());

    /**
     * Creates new form frmPhieuXuat
     */
    public frmPhieuXuat() throws SQLException {
        initComponents();
