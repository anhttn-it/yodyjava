 ...
 * @author ngocanh
 */
public class MuaHangpanel extends javax.swing.JPanel {
    ...
    public void ShowData() throws SQLException{
        List<MuaHang> list = bh.getAll(); 
        for(MuaHang phieu:list){
            Object[] row = new Object[6];
            row[0] = phieu.getMaMuaHang();
            row[1] = phieu.getNgayMua();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(102, 255, 102)), "Danh sách mua hàng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24), new java.awt.Color(0, 51, 204))); // NOI18N
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        ...
        try {
            ClearData();
            List<MuaHang> list = bh.TimKiemMH(keyword);
            if(list.isEmpty()){
    ...
    private void btnLuuBHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuBHActionPerformed
        ...
        if(makhObj == null || manvObj == null){
            ...
            try {
                ...
                obj.setNgayMua(now);   // tự động lấy thời gian hiện tại
